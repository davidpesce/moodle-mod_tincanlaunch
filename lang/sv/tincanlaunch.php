...
$string['tincansimplelaunchnav'] = 'Förenklad sjösättavigering';
$string['tincansimplelaunchnav_help'] = 'Om du väljer det, presentera ett förenklat användargränssnitt för launch navigation';
